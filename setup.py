...
from cryoassess import __version__
...
setup(
    ...
    name='scipion-em-cryoassess',  # Required
    ...
    description='Plugin to use cryoassess within the Scipion framework',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-cryoassess',  # Optional
    ...
    package_data={  # Optional
       'cryoassess': ['cryoassess_logo.png', 'protocols.conf'],
    },
    ...
    entry_points={
        'pyworkflow.plugin': 'cryoassess = cryoassess'
    }
)
